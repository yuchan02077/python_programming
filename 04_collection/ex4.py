...
print(max(scores))
print(min(scores))                                                    # ✅ max 점수: 92점, min 점수: 76점
...
# 총 재고 금액 출력
result = tuple((b * c for a, b, c in stocks)) # ✅ 총액: 21,000원
print(sum(result))
...
total = sum( w*e for q, w, e in zip(*stocks))
print(total)
result = tuple((d*k for k, d in zip(a, b)))
print(sum(result))